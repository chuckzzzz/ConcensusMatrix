...
percentile = 0.001
image_path = "/mnt/silencer2/home/ziz361/data/consensus_matrix_data/cs_random1_plot.png"
output_path = "/mnt/silencer2/home/ziz361/data/consensus_matrix_data/cs_random1_threshold.txt"
...
with open(output_path, "w") as text_file:
    print("Purchase Amount: {}".format(threshold), file=text_file)
